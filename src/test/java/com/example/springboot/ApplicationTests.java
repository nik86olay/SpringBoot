...
class ApplicationTests {
    ...
    void contextLoads() {
        ...
        ResponseEntity<String> forEntity1 = restTemplate.getForEntity("http://localhost:" + myapp1Port, String.class);
        //ResponseEntity<String> forEntity2 = restTemplate.getForEntity("http://localhost:" + myapp2Port, String.class);
